/**
 * Tailwind config transcribed verbatim from the Stitch export's inline
 * `#tailwind-config` script (identical across all four screens).
 *
 * This file is only needed to REGENERATE css/app.css. The shipped project
 * ships the compiled stylesheet, so nothing here runs at page-load time.
 *
 * Regenerate with:  npm run build   (see _build/README.md)
 */
module.exports = {
  darkMode: "class",
  content: [
